...
```
server {
    server_name 79.174.80.181; # указать домен или ip-адрес
...
Проект Django + React должен быть полностью доступен по http://79.174.80.181 на обычном порту 80.
...
По пути http://79.174.80.181/signup находится форма регистрации пользователя
